...
class Model_Building:
    ...
    def XLRMBERTmodelDomain(self):
        ...
        print(model.summary())
        tf.keras.utils.plot_model(model, to_file='project/output/model_plots/Xlrm_Bert_Domain_model_plot.png', show_shapes=True, show_layer_names=True)
        return model
    ...
    def DistillMBERTmodelDomain(self):

        #constructing model with three inputs
        title_input = keras.Input(shape=(512,))
        description_input = keras.Input(shape=(512,))
        domain_input = keras.Input(shape=(512,))


        # the first branch operates on the title input
        x = Dense(256, activation="relu")(title_input)
        x= Dropout(0.4)(x)
        ...
        # the second branch opreates on the description
        y = Dense(256, activation="relu")(description_input)
        y= Dropout(0.5)(y)
        y = Dense(128, activation="relu")(y)
        y= Dropout(0.5)(y)
        ...
        model = Model(inputs=[x.input, y.input,domain_input], outputs=z)
        print(model.summary())
        tf.keras.utils.plot_model(model, to_file='project/output/model_plots/Distill_Multi_Bert_Domain_model_plot.png', show_shapes=True, show_layer_names=True)
        return model

    def DistillMBERTmodel(self):
        title_input = keras.Input(shape=(512,))
        description_input = keras.Input(shape=(512,))
        ...
        model = Model(inputs=[title_input,description_input], outputs=x)
        print(model.summary())
        tf.keras.utils.plot_model(model, to_file='project/output/model_plots/Distill_Multi_Bert_model_plot.png', show_shapes=True, show_layer_names=True)
        return model

    def MUSEmodelDomain(self):
        ...
        model = Model(inputs=[x.input, y.input,domain_input], outputs=z)
        print(model.summary())
        tf.keras.utils.plot_model(model, to_file='project/output/model_plots/M_USE_Domain_model_plot.png', show_shapes=True, show_layer_names=True)
        return model
    ...
    def MUSEmodel(self):
        ...
        model = Model(inputs=[title_input,description_input], outputs=x)
        print(model.summary())
        tf.keras.utils.plot_model(model, to_file='project/output/model_plots/M_USE_model_plot.png', show_shapes=True, show_layer_names=True)
        return model